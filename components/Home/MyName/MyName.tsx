...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m a dedicated <span className="text-AAsecondary">software developer and tester</span> with a strong foundation in both coding and quality assurance.
        <br className="2xl:block hidden" />
        I thrive on creating efficient, reliable software solutions and ensuring they meet the highest standards.
        <br className="2xl:block hidden"/>
