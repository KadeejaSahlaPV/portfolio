...
export default function Home() {
  ...
  const meta = {
    title: "Kadeeja Sahla - Software Engineer",
    description: `I am a Software developer. Get in touch with me to know more.`,
    image: "/pic.jpg",
    type: "website",
  };
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? (
            <Footer githubUrl={"https://www.linkedin.com/in/kadeejasahla/"} hideSocialsInDesktop={true} />
          ) : (
            <></>
          )}
